  ...
  return (
    <>
      ...
      <SidebarInset className="z-10">
        <header className="fixed z-10 flex h-12 w-full shrink-0 items-center justify-between bg-background transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-10">
